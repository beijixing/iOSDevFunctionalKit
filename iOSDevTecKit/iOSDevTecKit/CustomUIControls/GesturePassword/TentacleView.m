...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (self.touchEndDelegate && [self.touchEndDelegate respondsToSelector:@selector(gestureTouchEndWithDotCounts:)]) {
        [self.touchEndDelegate gestureTouchEndWithDotCounts:touchesArray.count];
        [self enterArgin];
    }
